...
struct Stats
{
  ...
  std::map <Name,long long> pattern;
};
/// @endcond
...
public:
   ...
   */
  static void
  InstallAll (const std::string &file, Time startTime, Time finishTime = Seconds (0.5));
   ...
   */
  static void
  Install (const NodeContainer &nodes, const std::string &file, Time startTime, Time finishTime = Seconds (0.5));
   ...
   */
  static void
  Install (Ptr<Node> node, const std::string &file, Time startTime, Time finishTime = Seconds (0.5));
   ...
   */
  static Ptr<CsTracer>
  Install (Ptr<Node> node, boost::shared_ptr<std::ostream> outputStream, Time startTime, Time finishTime = Seconds (0.5));
...
private:
  void
  SetTimes (const Time &periodS, const Time &periodF);
